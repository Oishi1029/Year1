...
text(vx, vy, 'V', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'bottom','FontSize', 12); % Central voltage  
for offset = [-voltage_uncertainty, voltage_uncertainty]
    new_vx = vx + offset;
    text(new_vx,  new_vy, 'V (?)', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'bottom','FontSize', 12); % Uncertain phasors
end

% Labels for current phasors
text(ix, iy, 'I', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'bottom','FontSize', 12); % Central current
for offset = [-current_uncertainty, current_uncertainty]
    new_ix = ix + offset;
    text(new_ix, new_iy, 'I (?)', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'bottom','FontSize', 12); % Uncertain phasors
end
